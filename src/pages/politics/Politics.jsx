      ...
      <div className={styles.containerFluid}>
        <div className={styles.container}>
          ...
          <p>
            ...
            которую сайт <strong>www.ommy.by</strong>, (далее – ommy)
            расположенный на доменном имени <strong>ommy.by</strong> (а также
            его субдоменах), может получить о Пользователе во время
          ...
          <p>
            ...
            <strong>www.ommy.by</strong>, которые организуют и (или)
          ...
          <p>
            1.1.5. «Сайт <strong> www.ommy.by</strong>» - это совокупность
            связанных между собой веб-страниц, размещенных в сети Интернет по
            уникальному адресу (URL): <strong>ommy.by</strong>, а также его
            субдоменах.
          </p>
          ...
          <p>
            ...
            www.ommy.by, а также другие временные страницы, внизу который
            указана контактная информация Администрации
          </p>

          <p>
            1.1.5. «Пользователь сайта <strong>www.ommy.by</strong> » (далее
            Пользователь) – лицо, имеющее доступ к сайту{" "}
            <strong>www.ommy.by</strong>, посредством сети Интернет и
            использующее информацию, материалы и продукты сайта{" "}
            <strong>www.ommy.by</strong>.
          </p>
          ...
          <p>
            ...
            сети, через который Пользователь получает доступ на ommy.
          </p>

          <h2>2. Общие положения</h2>
          <p>
            2.1. Использование сайта www.ommy.by Пользователем означает согласие
          ...
          <p>
            ...
            Пользователь должен прекратить использование сайта www.ommy.by .
          </p>

          <p>
            2.3. Настоящая Политика конфиденциальности применяется к сайту
            www.ommy.by. ommy не контролирует и не несет ответственность за
            сайты третьих лиц, на которые Пользователь может перейти по ссылкам,
            доступным на сайте www.ommy.by.
          </p>
          ...
          <p>
            ...
            www.ommy.by или при подписке на информационную e-mail рассылку.
          </p>
          ...
          <p>
            ...
            заполнения форм на сайте www.ommy.by и включают в себя следующую
            информацию:
            <br />
          ...
          <p>
            3.3. ommy защищает Данные, которые автоматически передаются при
            посещении страниц:
            <br />
            - IP адрес;
            <br />
          ...
          <p>
            3.3.2. ommy осуществляет сбор статистики об IP-адресах своих
          ...
          <p>
            ...
            www.ommy.by, если Пользователь дал согласие на создание учетной
            записи.
            <br />
            ...
            www.ommy.by.
            <br />
            4.1.9. Предоставления Пользователю специальных предложений,
            новостной рассылки и иных сведений от имени сайта www.ommy.by.
            <br />
            4.1.10. Предоставления персональной информации Пользователя третьему
            лицу для последующей связи третьего лица с Пользователем и
            предоставления ему запрашиваемых услуг.
          </p>
          ...
          <p>
            ...
            www.ommy.by, и давать согласие на их обработку.
          </p>
          ...
          <p>
            ...
            право не ограничено в соответствии с законом Республики Беларусь.
          ...
          <p>
            ...
            <br />
            7.2.3. Была разглашена или предоставлена третьему лицу с согласия
            Пользователя.
          </p>

          <p>
            7.3. Пользователь несет полную ответственность за соблюдение
            требований законодательства РБ, в том числе законов о рекламе, о
          ...
          <p>
            ...
            находящихся в свободном публичном доступе на сайте www.ommy.by)
          ...
          <p>
            ...
            иных коммуникационных данных, содержащихся на сайте www.ommy.by или
          ...
          <p>
            ...
            информацию, размещенную пользователем на сайте www.ommy.by, включая,
          ...
          <p>
            ...
            размещения на сайте www.ommy.by, если иное не предусмотрено новой
            редакцией Политики конфиденциальности.
          </p>

          <p>
            9.3. Все предложения или вопросы касательно настоящей Политики
            конфиденциальности следует сообщать по адресу: info@ommy.by
          </p>
